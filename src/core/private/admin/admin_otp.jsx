...
const adminOtp = yup.object().shape({
    otp: yup
        .string()
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="verify-otp-right-section">
                        <div className='verify-otp-title-subtitle-div'>
                            <p className='verify-otp-title'>Login Detected</p>
                            <p className='verify-otp-subtitle'>Check your email and enter the OTP to access the dashboard</p>
                        </div>
